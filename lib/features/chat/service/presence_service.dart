...
//       // Optional: add small data like 'username', 'avatar_url' if needed
//     };
//   }
...
//     // Fixed: Use entries() instead of forEach with wrong signature
//     for (final entry in presenceState) {
//       final presences = entry.presences;

//       for (final presence in presences) {
//         try {
//           // presence is already a Map, no need to cast
//           final payload = presence as Map<String, dynamic>;
