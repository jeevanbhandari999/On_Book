...
//     _initializePresenceForAllRooms();
//   }

//   Future<void> _initializePresenceForAllRooms() async {
//     // Wait for rooms to load
//     final chatBloc = context.read<ChatBloc>();
//     final state = chatBloc.state;

//     if (state is UserRoomsLoaded) {
//       final roomIds = state.rooms.map((room) => room.id).toList();
...
//   @override
//   void dispose() {
//     // Don't dispose here - keep presence active across app
//     super.dispose();
//   }
