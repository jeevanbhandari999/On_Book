...
// class AppColors {
//   // Primary Brand Colors (modern, trustworthy blue tone)
//   static const Color primary = Color(0xFF1565C0); // Strong Blue
//   static const Color primaryDark = Color(0xFF0D47A1); // Deep Navy Blue
//   static const Color primaryLight = Color(0xFFBBDEFB); // Soft Light Blue

//   // Secondary Accent (vibrant cyan hint for highlights)
