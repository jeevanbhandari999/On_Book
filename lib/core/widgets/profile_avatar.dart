...
// ─────────────────────────────────────────────────────────────────────────────
//
// Single-image mode  (allowMultiple: false – default)
//   • Calls [onImagePicked] with the chosen XFile.
//   • Shows a file-name + size row above the preview when [showFileName] = true.
//
// Multiple-image mode (allowMultiple: true)
//   • Calls [onMultipleImagesPicked] with the full list every time it changes.
//   • Renders a wrap of thumbnails with individual remove buttons plus an
//     "add more" tile (respecting [maxImages]).
// ─────────────────────────────────────────────────────────────────────────────
